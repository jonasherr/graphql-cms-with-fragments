...
export type introspection_types = {
    ...
    fields: {
      ...
      children: {
        ...
        type: {
          kind: "LIST";
          name: never;
          ofType: { kind: "OBJECT"; name: "Span"; ofType: null };
        };
      };
      level: {
        name: "level";
  ...
  Document: {
    ...
    fields: {
      ...
      _id: { name: "_id"; type: { kind: "SCALAR"; name: "ID"; ofType: null } };
      _rev: {
        name: "_rev";
        type: { kind: "SCALAR"; name: "String"; ofType: null };
      };
    ...
    possibleTypes: "Post" | "SanityFileAsset" | "SanityImageAsset";
  };
  DocumentFilter: {
    kind: "INPUT_OBJECT";
    name: "DocumentFilter";
  ...
  File: {
    ...
    fields: {
      ...
      asset: {
        name: "asset";
        type: { kind: "OBJECT"; name: "SanityFileAsset"; ofType: null };
      };
      media: {
        name: "media";
        type: { kind: "OBJECT"; name: "GlobalDocumentReference"; ofType: null };
      };
    };
  };
  FileFilter: {
  ...
  GeopointFilter: {
    ...
    inputFields: [
      ...
      {
        name: "lat";
        type: { kind: "INPUT_OBJECT"; name: "FloatFilter"; ofType: null };
        defaultValue: null;
      },
      {
        name: "lng";
  ...
  Image: {
    ...
    fields: {
      ...
      asset: {
        name: "asset";
        type: { kind: "OBJECT"; name: "SanityImageAsset"; ofType: null };
      };
      crop: {
        name: "crop";
        type: { kind: "OBJECT"; name: "SanityImageCrop"; ofType: null };
      };
      hotspot: {
        name: "hotspot";
        type: { kind: "OBJECT"; name: "SanityImageHotspot"; ofType: null };
      };
      media: {
        name: "media";
        type: { kind: "OBJECT"; name: "GlobalDocumentReference"; ofType: null };
  ...
  PostSorting: {
    ...
    inputFields: [
      ...
      {
        name: "slug";
        type: { kind: "INPUT_OBJECT"; name: "SlugSorting"; ofType: null };
        defaultValue: null;
      },
      {
        name: "excerpt";
  ...
  RootQuery: {
    ...
    fields: {
      Document: {
        name: "Document";
        type: { kind: "INTERFACE"; name: "Document"; ofType: null };
      };
      Post: {
        name: "Post";
        ...
        type: {
          ...
          ofType: {
            ...
            ofType: {
              kind: "NON_NULL";
              name: never;
              ofType: { kind: "INTERFACE"; name: "Document"; ofType: null };
            };
          };
        };
      };
        ...
        type: {
          ...
          ofType: {
            ...
            ofType: {
              kind: "NON_NULL";
              name: never;
              ofType: { kind: "OBJECT"; name: "SanityFileAsset"; ofType: null };
            };
          };
        };
      };
  ...
  SanityFileAsset: {
    ...
    fields: {
      ...
      source: {
        name: "source";
        type: { kind: "OBJECT"; name: "SanityAssetSourceData"; ofType: null };
      };
      title: {
        name: "title";
        type: { kind: "SCALAR"; name: "String"; ofType: null };
  ...
  SanityImageAsset: {
    ...
    fields: {
      ...
      metadata: {
        name: "metadata";
        type: { kind: "OBJECT"; name: "SanityImageMetadata"; ofType: null };
      };
      mimeType: {
        name: "mimeType";
        type: { kind: "SCALAR"; name: "String"; ofType: null };
  ...
  SanityImageMetadata: {
    ...
    fields: {
      ...
      dimensions: {
        name: "dimensions";
        type: { kind: "OBJECT"; name: "SanityImageDimensions"; ofType: null };
      };
      hasAlpha: {
        name: "hasAlpha";
        type: { kind: "SCALAR"; name: "Boolean"; ofType: null };
      ...
      location: {
        name: "location";
        type: { kind: "OBJECT"; name: "Geopoint"; ofType: null };
      };
      lqip: {
        name: "lqip";
        type: { kind: "SCALAR"; name: "String"; ofType: null };
      ...
      palette: {
        name: "palette";
        type: { kind: "OBJECT"; name: "SanityImagePalette"; ofType: null };
      };
    };
  };
  SanityImageMetadataFilter: {
    ...
    inputFields: [
      ...
      {
        name: "location";
        type: { kind: "INPUT_OBJECT"; name: "GeopointFilter"; ofType: null };
        defaultValue: null;
      },
      {
        name: "dimensions";
  ...
  SanityImageMetadataSorting: {
    ...
    inputFields: [
      ...
      {
        name: "location";
        type: { kind: "INPUT_OBJECT"; name: "GeopointSorting"; ofType: null };
        defaultValue: null;
      },
      {
        name: "dimensions";
